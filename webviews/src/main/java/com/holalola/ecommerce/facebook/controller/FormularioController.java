...
@ManagedBean(name = "formularioController")
@ViewScoped
@SuppressWarnings("serial")
public class FormularioController extends GeneralController {
	...
	public void inicializar() {			
		urlMalla = "https://sige.uisrael.edu.ec/InscripcionOnline/InscripcionPosgrado.aspx?fbclid=IwAR3gspGxV31Pf8Onag3t0SrIn7ROqsPj4IYoQcfsAZ0_cHWtyiEvX1lJQ6A";
